...
const ACTIONS: Record<string, ActionItem[]> = {
  ...
  CAUTION: [
    { icon: <Wind size={13} />, text: 'Monitor ventilation levels' },
    { icon: <CheckCircle size={13} />, text: 'Increase check frequency' },
  ],
  WARNING: [
    { icon: <Wind size={13} />, text: 'Check ventilation immediately', urgent: true },
  ...
  CRITICAL: [
    ...
    { icon: <Wind size={13} />, text: 'Activate emergency ventilation', urgent: true },
